...
Group.new("String", colors.blue, colors.none, styles.italic)
...
Group.new("cStructure", colors.blue, colors.none, styles.bold)
Group.new("cStorageClass", colors.orange, colors.none, styles.bold)
Group.new("cKeyword", colors.cyan_new, colors.none, styles.bold)
Group.new("cSpecialChar", colors.orange, colors.none, styles.bold)
Group.new("clangd", colors.red, colors.none, styles.bold)
...
-- Telescope
Group.new("TelescopePromptBorder", colors.white, colors.none)
Group.new("TelescopePromptNormal", colors.white, colors.none)
Group.new("TelescopePromptTitle", colors.white, colors.none)
Group.new("TelescopePreviewBorder", colors.blue, colors.none)
Group.new("TelescopeResultsBorder", colors.white, colors.none)
...
-- Group.new("htmlEndTag", colors.blue, colors.none, no)
