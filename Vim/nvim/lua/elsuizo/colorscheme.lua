-- Name:         lowentropy
-- Description:  low visual noise colorscheme
-- Author:       elsuizo
-- Maintainer:   elsuizo
-- Website:      ...
-- License:      MIT
...
function M.load()
    ...
    Color.new('comments', '#5688af')
    Color.new('error', get_color('red'))
    Color.new('pink', get_color('pink'))
    Color.new('incsearch', get_color('orange'))
    Color.new('search', get_color('orange'))
    Color.new('Constant', get_color('orange'))
    Color.new('String', get_color('blue'))
    Color.new('Character', get_color('monoblue'))
    Color.new('Boolean', get_color('red'))
    Color.new('Float', get_color('red'))
    Color.new('Identifier', get_color('brightwhite'))
    Color.new('Function', get_color('brightwhite'))
    Color.new('Statement', get_color('brightwhite'))
    Color.new('Conditional', get_color('brightwhite'))
    Color.new('Repeat', get_color('brightwhite'))
    Color.new('Label', get_color('linenrblack'))
    Color.new('Operator', get_color('brightwhite'))
    Color.new('Number', get_color('red'))
    Color.new('Keyword', get_color('brightwhite'))
    Color.new('Exception', get_color('red_dark'))
    Color.new('PreProc', get_color('orange'))
    ...
    Color.new('Typedef', get_color('orange'))
    Color.new('Special', get_color('blue'))
    Color.new('SpecialChar', get_color('red_fluo'))
    Color.new('Tag', get_color('brightwhite'))
    Color.new('Delimiter', get_color('brightwhite'))
    Color.new('SpecialComment', get_color('red'))
    ...
    Group.new('Function', c.Function, c.none, b) -- function name (also: methods for classes)
   ...
   --NOTE(elsuizo: 2023-05-12): este parece que no anda
...
function M.icon_load()
    if vim.g.colors_name == 'lowentropy' and vim.g.snazzybuddy_icons then
        require'snazzybuddy.icons'.setup(Group)
    end
end

function M.colorscheme_refresh()
    if vim.g.colors_name == 'lowentropy' then
        M.icon_load()
    end
end
