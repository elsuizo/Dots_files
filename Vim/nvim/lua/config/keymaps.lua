...
-- Neorg mappings
vim.keymap.set("n", "<Space>T", ":Neorg workspace todos<cr>") -- go to todos Neorg file
vim.keymap.set("n", "<Space>R", ":Neorg workspace remember<cr>") -- go to remember Neorg file
-- floating terminal
